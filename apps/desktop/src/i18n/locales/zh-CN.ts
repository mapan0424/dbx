...
export default withEnglishFallback({
  ...
  contextMenu: {
    ...
    xuguScheduler: "虚谷调度作业",
    openXuguScheduler: "打开虚谷调度作业",
    xuguMonitor: "虚谷实例监控",
    openXuguMonitor: "打开虚谷实例监控",
    newQuery: "新建查询",
    instanceInfo: "实例信息",
    newInsert: "新建新增",
    newSql: "新建 SQL",
    ...
    compileProcedure: "编译存储过程",
    compileFunction: "编译存储函数",
    compilePackage: "编译包",
    compileType: "编译类型",
    viewDependencies: "查看依赖关系",
    dropPartition: "删除分区",
    viewTablespaces: "查看表空间与数据文件",
    enableTrigger: "启用触发器",
    disableTrigger: "禁用触发器",
    recompileTrigger: "重新编译触发器",
    confirmExecuteProcedureTitle: "执行存储过程",
    confirmExecuteProcedureMessage: "确认执行存储过程「{name}」？可先补充或调整参数值。",
    confirmExecuteFunctionTitle: "执行存储函数",
    confirmExecuteFunctionMessage: "确认执行存储函数「{name}」？可先补充或调整参数值。",
    ...
    dropType: "删除类型",
    confirmDropTypeTitle: "删除类型",
    confirmDropTypeMessage: "确定要删除类型「{name}」吗？如有依赖对象，数据库将阻止此操作。",
    dropViewSuccess: "视图「{name}」已删除",
    dropProcedureSuccess: "存储过程「{name}」已删除",
    dropFunctionSuccess: "函数「{name}」已删除",
    dropPackageSuccess: "包「{name}」已删除",
    dropTypeSuccess: "类型「{name}」已删除",
  ...
  userAdmin: {
    title: "用户与权限",
    unsupported: "当前支持 MySQL 兼容、PostgreSQL 兼容和虚谷数据库连接。SQL Server、Oracle 等会按各自权限模型继续扩展。",
    newUser: "新建用户",
    newPrincipal: "新建用户或角色",
    createRole: "创建角色（不创建用户）",
    principalName: "用户或角色名",
    anonymous: "匿名用户",
    roleName: "角色名",
    allowLogin: "允许登录",
  ...
  xuguScheduler: {
    ...
    jobType: "作业类型",
    argumentCount: "参数个数",
    argumentValues: "参数值（每行一个 SQL 表达式）",
    argumentValuesHint: "例如：42\n'daily'\nSYSDATE",
    startDate: "开始时间",
    endDate: "结束时间",
    repeatInterval: "调度时间串",
    comments: "备注",
    autoDrop: "结束后自动删除",
    previewSql: "预览 SQL",
    sqlPreview: "SQL 预览",
  ...
  xuguMonitor: {
    ...
    version: "服务端版本",
    onlineNodes: "在线节点",
    activeTransactions: "活动事务",
    lockWaits: "锁等待",
    nodes: "节点",
    readOnlyHint: "仅读取系统视图",
    node: "节点",
    type: "类型",
    state: "状态",
    cpuLoad: "CPU 负载",
    ...
    stores: "{count} 个本地存储",
    emptyNodes: "暂无节点信息。",
    nodeState: { joining: "加入中", running: "运行中", error: "异常", offline: "离线", unknown: "未知" },
    nodeType: { master: "主 Master", standby: "备 Master", storage: "存储节点", unknown: "未知" },
  },
  objects: {
    all: "全部",
    tables: "表",
