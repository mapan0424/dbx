export default {
  ...
  contextMenu: {
    ...
    xuguScheduler: "XuguDB Scheduler",
    openXuguScheduler: "Open XuguDB Scheduler",
    xuguMonitor: "XuguDB Monitor",
    openXuguMonitor: "Open XuguDB Monitor",
    ...
    viewTablespaces: "View Tablespaces & Data Files",
    enableTrigger: "Enable Trigger",
    disableTrigger: "Disable Trigger",
    recompileTrigger: "Recompile Trigger",
    ...
    confirmExecuteFunctionTitle: "Execute Function",
    confirmExecuteFunctionMessage: 'Execute function "{name}"? You can fill or adjust parameter values first.',
    ...
    dropType: "Drop Type",
    confirmDropTypeTitle: "Drop Type",
    confirmDropTypeMessage: 'Are you sure you want to drop type "{name}"? Dependent objects may prevent this operation.',
    dropViewSuccess: 'View "{name}" dropped',
    dropProcedureSuccess: 'Procedure "{name}" dropped',
    dropFunctionSuccess: 'Function "{name}" dropped',
    dropPackageSuccess: 'Package "{name}" dropped',
    dropTypeSuccess: 'Type "{name}" dropped',
  ...
  tree: {
    ...
    xuguScheduler: "Scheduler",
    xuguMonitor: "Instance Monitor",
  ...
  userAdmin: {
    ...
    unsupported: "MySQL-compatible, PostgreSQL-compatible, and XuguDB connections are supported. SQL Server, Oracle, and other permission models can be added next.",
    newUser: "New User",
    newPrincipal: "New User / Role",
    createRole: "Create a role instead of a user",
    principalName: "User or role name",
    anonymous: "Anonymous",
    roleName: "Role name",
  ...
  xuguScheduler: {
    ...
    argumentValues: "Argument values (one SQL expression per line)",
    argumentValuesHint: "For example: 42\n'daily'\nSYSDATE",
    startDate: "Start date",
    endDate: "End date",
  ...
  xuguMonitor: {
    ...
    nodes: "Nodes",
    readOnlyHint: "Read-only system views",
    node: "Node",
    type: "Type",
    state: "State",
    cpuLoad: "CPU load",
    ...
    bootTime: "Boot time",
    rack: "Rack {rack}",
    stores: "{count} local stores",
    emptyNodes: "No node information is available.",
    nodeState: { joining: "Joining", running: "Running", error: "Error", offline: "Offline", unknown: "Unknown" },
    nodeType: { master: "Master", standby: "Standby master", storage: "Storage", unknown: "Unknown" },
  },
  objects: {
    all: "All",
    tables: "Tables",
